...
\lstset{%
    ...
    morekeywords = { %
        ...
        %
        PlotDataLines, %
        PlotDataLinesLogLogScale, %
        PlotDataLinesSemiLogScaleX, %
        PlotDataLinesSemiLogScaleY, %
        %
        PlotDataPoints, %
        PlotDataPointsLogLogScale, %
        PlotDataPointsSemiLogScaleX, %
        PlotDataPointsSemiLogScaleY, %
        %
        PlotLabelledDataLine, %
        PlotLabelledDataLineLogLogScale, %
        PlotLabelledDataLineSemiLogScaleX, %
        PlotLabelledDataLineSemiLogScaleY, %
        %
        PlotOneParameterLinearRegression, %
        PlotTwoParameterLinearRegression, %
        %
        PlotSmoothLabelledDataLine, %
        PlotSmoothLabelledDataLineLogLogScale, %
        PlotSmoothLabelledDataLineSemiLogScaleX, %
        PlotSmoothLabelledDataLineSemiLogScaleY, %
        %
        PlotSmoothLabelledDataPoints, %
        PlotSmoothLabelledDataPointsLogLogScale, %
        PlotSmoothLabelledDataPointsSemiLogScaleX, %
        PlotSmoothLabelledDataPointsSemiLogScaleY, %
        %
        PrintImage, %
        %
        TabulateData, %
...
\begin{description}
% ----------
    \item[\hspace{-1em}]{\lstinline|\PlotDataLines{<dat>}{<refer>}{<cap>}{<xlabel>}{<xunit>}{<ylabel>}{<yunit>}| \index{Plot!Data Lines}}
        ...
        \par{\footnotesize{\emph{Modified:}} \lstinline{\PlotDataLinesLogLogScale} \index{Plot!Data Lines!LogLogScale}, \lstinline{\PlotDataLinesSemiLogScaleX} \index{Plot!Data Lines!Semi-Log Scale X}, \lstinline{\PlotDataLinesSemiLogScaleY} \index{Plot!Data Lines!Semi-Log Scale Y}}
% ----------
    \item[\hspace{-1em}]{\lstinline|\PlotDataPoints{<dat>}{<refer>}{<cap>}{<xlabel>}{<xunit>}{<ylabel>}{<yunit>}| \index{Plot!Data Points}}
        ...
        \par{\footnotesize{\emph{Modified:}} \lstinline{\PlotDataPointsLogLogScale} \index{Plot!Data Points!Log-Log Scale}, \lstinline{\PlotDataPointsSemiLogScaleX} \index{Plot!Data Points!Semi-Log Scale X}, \lstinline{\PlotDataPointsSemiLogScaleY} \index{Plot!Data Points!Semi-Log Scale Y}.}
% ----------
\end{description}

\par{The following code example generates the output shown in Figure~\ref{fig:plain-line-plot}.}

\begin{lstlisting}
\PlotDataLines{data-set-1.csv}
              {plain-line-plot}
              {Line Plot of Data set 1}
              {Data}
              {$2 \theta$}
              {\si{\degree}}
              {Intensity}
...
\begin{description}
% ----------
    \item[\hspace{-1em}]{\lstinline|\PlotLabelledDataLine{<dat>}{<refer>}{<cap>}{<xlabel>}{<xunit>}{<ylabel>}{<yunit>}{<markers>}| \index{Plot!Labelled Line}}
        ...
        \par{\footnotesize{\emph{Modified:}} \lstinline{\PlotLabelledDataLineLogLogScale} \index{Plot!Labelled Line!Log-Log Scale}, \lstinline{\PlotLabelledDataLineSemiLogScaleX} \index{Plot!Labelled Line!Semi-Log Scale X},
            \\
            \lstinline{\PlotLabelledDataLineSemiLogScaleY} \index{Plot!Labelled Line!Semi-Log Scale Y}.}
% ----------
    \item[\hspace{-1em}]{\lstinline|\PlotSmoothLabelledDataPoints{<dat>}{<refer>}{<cap>}{<xlabel>}{<xunit>}{<ylabel>}{<yunit>}{<markers>}| \index{Plot!Smooth Labelled Points}}
        \par{Generate a scatter plot of $x$ vs $y$ data in the data file \lstinline{<dat>}. The plot is referenced by \lstinline{<refer>} and caption \lstinline{<cap>}.  The parameters \lstinline{<xlabel>}, \lstinline{<xunit>}, \lstinline{<ylabel>} and \lstinline{<yunit>} are the $x$-axis label and unit specifications, and $y$-axis label and unit specifications, respectively.  Additional decorations may be added to this plot in the \lstinline{<markers>} list parameter.}
        \par{\footnotesize{\emph{Modified:}} \lstinline{\PlotSmoothLabelledDataPointsLogLogScale} \index{Plot!Smooth Labelled Points!Log-Log Scale}, \lstinline{\PlotSmoothLabelledDataPointsSemiLogScaleX} \index{Plot!Smooth Labelled Points!Semi-Log Scale X},
            \\
            \lstinline{\PlotSmoothLabelledDataPointsSemiLogScaleY} \index{Plot!Smooth Labelled Points!Semi-Log Scale Y}.}
% ----------
    \end{description}

\par{The following code example generates the output shown in Figure~\ref{fig:semi-log-scale-y-plot}.}

\begin{lstlisting}
\PlotSmoothLabelledDataPointsSemiLogScaleY{data-set-2.csv}
                                          {semi-log-scale-y-plot}
                                          {Smooth and labelled data set plot}
                                          {Data}
                                          {$2 \theta$}
                                          {\si{\degree}}
                                          {Intensity}
...
\PlotSmoothLabelledDataPointsSemiLogScaleY{narrow-spectrum-30kV-no-filter.csv}
                                          {semi-log-scale-y-plot}
                                          {Smooth and labelled data set plot}
                                          {Data}
                                          {$2 \theta$}
...
\begin{lstlisting}
\PlotTwoParameterLinearRegression{data-set-3.csv}
                                 {two-param-linear-regression}
                                 {Two parameter linear regression plot.}
                                 {Data}
                                 {$\lambda^{-1}_{min}$}
                                 {\si{\per\angstrom}}
                                 {Potential}
...
\begin{description}
% ----------
    \item[\hspace{-1em}]{\lstinline|\AddDataPoints{<dat>}{<legend>}| \index{Add!Points}}
...
% ----------
    \item[\hspace{-1em}]{\lstinline|\AddDataLines{<dat>}{<legend>}| \index{Add!Line}}
...
\PlotCollectionSemiLogScaleY{collection-log-scale-y}
                ...
                {counts}
                {
                    \AddDataLines{data-set-4.csv}{Data Set 4}
                    \AddDataPoints{data-set-5.csv}{Data Set 5}
                    \AddThreePointMeanThresholdSmoothing{data-set-5.csv}{Data Set 5}{80}
...
\PlotCollectionSemiLogScaleY{collection-log-scale-y}
                            ...
                            {counts}
                            {%
                                \AddDataLines{wide-spectrum-30kV-unknown-filter.csv}{Data Set 3}
                                %
                                \AddDataPoints{wide-spectrum-30kV-Nickle-filter.csv}{Data Set 4}
                                \AddThreePointMeanThresholdSmoothing{wide-spectrum-30kV-Nickle-filter.csv}{Data Set 4}{80}
                                %
                                \AddVerticalMarker{32.81}
                                %
                                \AddHorizontalMarker{30}

...
\PlotSmoothLabelledDataPointsSemiLogScaleY{narrow-spectrum-25kV-no-filter.csv} % data file name
...
\PlotSmoothLabelledDataPointsSemiLogScaleY{narrow-spectrum-30kV-no-filter.csv} % data file name
...
\PlotSmoothLabelledDataPointsSemiLogScaleY{narrow-spectrum-35kV-no-filter.csv} % data file name
...
\PlotLabelledDataLine{wide-spectrum-30kV-no-filter.csv} % data file nome
...
\PlotLabelledDataLine{wide-spectrum-30kV-Nickle-filter.csv} % path to data file data
...
\PlotLabelledDataLineSemiLogScaleY{wide-spectrum-30kV-unknown-filter.csv} % path to data file data
...
\PlotLabelledDataLine{powder.csv} % path to data file data
